...
public class ValidateEquityFuturesCategory extends Base {
	
	@Test
	public void validateEquityFutures()
	{
...
//		e.getCheckBox(driver);
	...
	/*	OnBoardPage1 o = new OnBoardPage1(driver);
		...
		wait.until(ExpectedConditions.visibilityOf(c.equityFutures));
		c.getEquityFutures();
//		c.getSkip(driver);
		c.getEquityFuturestitle();
		c.getNewCall();
	}
