...
public class ValidateCommodityOptionCategory extends Base{

	@Test
	public void validateCommodityOption()
	{
	...
	/*	OnBoardPage1 o = new OnBoardPage1(driver);
		...
		wait.until(ExpectedConditions.visibilityOf(c.commodityOption));
	    c.getCommodityOption();
	//	c.getSkip(driver);
		c.getCommodityOptiontitle();
		c.getNewCall();
	}
}
