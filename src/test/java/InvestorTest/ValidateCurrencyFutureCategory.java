...
public class ValidateCurrencyFutureCategory extends Base{
	
	@Test
	public void validateCurrencyFuture()
	{
	...
	/*	OnBoardPage1 o = new OnBoardPage1(driver);
		...
		wait.until(ExpectedConditions.visibilityOf(c.currenciesFuture));
		c.getCurrenciesFuture();
	//	c.getSkip(driver);
		c.getCurrencyFuturetitle();
		c.getNewCall();
	}
