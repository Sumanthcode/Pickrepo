...
public class ValidateCommodityFutureCategory extends Base {

	@Test
	public void validateCommodityFuture()
	{
	...
	/*	OnBoardPage1 o = new OnBoardPage1(driver);
		...
		wait.until(ExpectedConditions.visibilityOf(c.commodityFuture));
	    c.getCommodityFuture();
	//	c.getSkip(driver);
		c.getCommodityFuturetitle();
		c.getNewCall();
	}
}
