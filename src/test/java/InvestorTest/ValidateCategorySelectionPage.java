...
public class ValidateCategorySelectionPage extends Base{
	...
	/*	OnBoardPage1 o = new OnBoardPage1(driver);
		...
		wait.until(ExpectedConditions.visibilityOf(c.equityCash));
		c.getEquityCategories();
		c.getCurrencyCategories();
		c.getCommodityCategories();
