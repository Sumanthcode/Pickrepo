...
import PageObject_Advisor.A_CommodityOptionCallPage;
...
public class A_ValidatePublishCommodityOptionCall extends Base{
	
	A_AdvisorDashBoardPage a;
	A_CommodityOptionCallPage c;
	String scriptName;
	@Test(priority=1)
	public void validateSuccessfullCreationOfCall1() throws InterruptedException, AWTException
	{
		...
		a.getCreateCall();
		c = new A_CommodityOptionCallPage(driver);
		c.setscripNameField("COPPER");
		scriptName=c.getCommodityOptionAutoSuggesions();
		c.getCallTypeBuy();
