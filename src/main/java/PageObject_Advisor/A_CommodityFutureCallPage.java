...
public class A_CommodityFutureCallPage {
...
WebDriver driver;
	...
	public List<WebElement> commodityFutureAutoSuggesions;
	...
	public A_CommodityFutureCallPage(WebDriver driver)
	{
	...
	public String getCommodityFutureAutoSuggesions() throws InterruptedException, AWTException {
		Thread.sleep(2000);
		Robot r = new Robot();
		r.keyPress(KeyEvent.VK_BACK_SPACE);
		Thread.sleep(2000);
		String scripName = commodityFutureAutoSuggesions.get(1).getText();
		commodityFutureAutoSuggesions.get(1).click();
		return scripName;
	}
